...
# 화면 타이틀 설정
pygame.display.set_caption("어린양아, 벌레소를 피해보렴")    # 게임 이름 설정
...
enemy_y_pos = screen_height / 2 - enemy_height / 2   # 화면 세로의 맨 밑에 해당하는 곳에 위치
...
# 20fps : 1초에 20번 동작 -> 1번에 5만큼 이동해야 함
    ...
    title = title_font.render(str("<SHEEP VS BUGCOW>"), True, (255, 255, 255))
